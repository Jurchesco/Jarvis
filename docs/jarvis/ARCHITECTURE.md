...
Instrukcja systemowa Gema (trener prowadzi 4 sekcjami; cron Telegram: druga wiadomość tylko `data/dowód`; źródło Hermes `jarvis-trener`): [GEM_INSTRUKCJA.md](./GEM_INSTRUKCJA.md)
