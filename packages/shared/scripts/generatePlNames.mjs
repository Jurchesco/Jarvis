...
const EXACT = {
  ...
  "air bike": "Rower powietrzny (air bike)",
  "all fours squad stretch": "Rozciąganie w pozycji na czworakach",
  "alternate heel touchers": "Naprzemienne dotykanie pięt",
  "ankle circles": "Krążenia kostkami",
  "archer pull up": "Podciąganie łucznicze",
  "archer push up": "Pompka łucznicza",
  "arm slingers hanging bent knee legs": "Unoszenie nóg w zwisie (kolana zgięte)",
  "arm slingers hanging straight legs": "Unoszenie nóg w zwisie (proste nogi)",
  "arms apart circular toe touch (male)": "Dotykanie palców stóp w rozkroku (okrężnie)",
  "arms overhead full sit-up (male)": "Brzuszki z rękami nad głową",
  "back and forth step": "Kroki w przód i w tył",
  "back lever": "Back lever",
  "balance board": "Deska równoważna",
  "basic toe touch (male)": "Skłon do palców stóp",
  "battling ropes": "Liny battle rope",
  "bear crawl": "Chód niedźwiedzia",
  "bridge - mountain climber (cross body)": "Mostek + mountain climber (cross-body)",
  "butterfly yoga pose": "Pozycja motyla (joga)",
  "crab twist toe touch": "Dotykanie stóp w skręcie (pozycja kraba)",
  "cross body crunch": "Crunch skośny (cross-body)",
  "hamstring": "Tył uda",
  "lever leg press": "Wypychanie nogami na maszynie",
  "leg press": "Wypychanie nogami",
  "plank": "Deska",
  "front plank with twist": "Deska z rotacją",
  "power point plank": "Deska (power point)",
  "push-up to side plank": "Pompka do deski bocznej",
  "reverse plank with leg lift": "Deska odwrotna z unoszeniem nogi",
  "side plank hip adduction": "Deska boczna — przywodzenie biodra",
  "weighted front plank": "Deska z obciążeniem",
  "bodyweight incline side plank": "Deska boczna na skosie (masa ciała)",
  "dumbbell side plank with rear fly": "Deska boczna z rozpiętką (hantel)",
  "kneeling plank tap shoulder (male)": "Deska klęcząc — tapnięcie barku",
  "assisted chest dip (kneeling)": "Dip na klatkę klęcząc (z pomocą)",
  "assisted prone hamstring": "Rozciąganie tyłu uda na brzuchu (z pomocą)",
  "assisted seated pectoralis major stretch with stability ball":
    "Rozciąganie klatki siedząc z piłką (z pomocą)",
  "assisted side lying adductor stretch": "Rozciąganie przywodzicieli leżąc bokiem (z pomocą)",
